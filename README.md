...
Homage to the legendary **TV Typewriter (1973)** by Don Lancaster, recreated with an **Arduino Nano** and **3 adkeys**.
...
Connect keypads Out to A3, A4 and A5
---
...
Upload the provided **tv3.ino sketch** to the Arduino Nano.
